This is a new Shared Collection (integration settgings) to be use in Cenit, named cenit-collection-twilio_api.

Cenit is an open source social platform as a service for data and business integration.

# CenitCollectionTwilioApi
...
```ruby
gem 'cenit-collection-twilio_api'
```
...
Or install it yourself as:
    ...
    $ gem install cenit-collection-twilio_api
...
% tree
.
├── cenit-collection-cenit-collection-twilio_api.gemspec
├── Gemfile
├── .gitignore
├── .rspec
├── README.md
    ...
    └── cenit
        └── collection
            └── cenit-collection-twilio_api
                 ...
                 └── build.rb
                 └── version.rb
            └── cenit-collection-twilio_api.rb
└── spec
    └── cenit
        └── collection
            └── cenit-collection-twilio_api_spec.rb
    └── spec_helper.rb
    └── support
        └── samples
```
...
1. Fork it ( https://github.com/[my-github-username]/cenit-collection-twilio_api/fork )
